          ...
          <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-12">
            ...
            <div>
              ...
              <p className="text-primary font-medium mb-4">
                Awarded at Maple Tech Space
              </p>
              <p className="text-neutral-300 leading-relaxed max-w-2xl">
                Recognized for exceptional performance, consistent high-quality
                contributions, and dedication to technical excellence within the
                organization.
              </p>
            </div>
          </div>
